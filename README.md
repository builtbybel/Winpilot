...
- It features a **BloatFinder app**, which allows you to remove pre-installed apps automatically or the manual way. Currently the instapackage app is also integrated to install some of the most important programs with one click
