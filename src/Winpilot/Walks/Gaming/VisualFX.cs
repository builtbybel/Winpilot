...
namespace Walks
{
    public class VisualFX: WalksBase
    {
        public VisualFX(MainForm form, Logger logger) : base(form, logger)
        {
        }
        ...
        {
            return Utils.IntEquals(keyName, "VisualFXSetting", desiredValue);
        }
